...
#
sensors = {
    "TL": Sensor(x=0,y=50,d=300,angle=-90,debug=False),
    "BL": Sensor(x=0,y=0,d=300,angle=-90,debug=False),
    "BR": Sensor(x=25,y=0,d=300,angle=90,debug=False),
    "TR": Sensor(x=25,y=50,d=300,angle=90,debug=False),
    "Front": Sensor(x=12.5,y=50,d=300,angle=0,debug=True)
}
...
cameras = {
    'main': Camera(x=12.5,
                   ...
                   resolution=160, # How many rays are in the field of view
                   debug=True
                   )
}
...
robot = RobotSim(location=(100,100),
                           length=50,
                           width=25,
                           algorithm=algorithm,
                           sensors=sensors,
